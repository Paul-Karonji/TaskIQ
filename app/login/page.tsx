      ...
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-xl">
        ...
        <div className="mt-8">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-gray-700 shadow-md transition hover:bg-gray-50 border border-gray-300"
            >
