    ...
    tasks.length !== 1 ? 's' : ''
          ...
          <div style="text-align: center; padding: 20px 0; color: #9CA3AF; font-size: 12px;">
            ...
            <p style="margin: 12px 0 0; font-size: 11px; color: #9CA3AF;">
              Made with care by <a href="https://wiktechnologies.com" target="_blank" rel="noopener noreferrer" style="font-weight: 600; color: #6B7280; text-decoration: none;">WIK Technologies</a>
            </p>
          </div>
        </div>
      </body>
